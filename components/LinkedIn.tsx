...
const LinkedIn = () => {
  return (
    <div>
<svg fill="#ff7900 " width="64px" height="64px" viewBox="-1920 -1920 5760.00 5760.00" xmlns="http://www.w3.org/2000/svg">

<g id="SVGRepo_bgCarrier" stroke-width="0">

<rect x="-1920" y="-1920" width="5760.00" height="5760.00" rx="1152" fill="#2D2E32" strokeWidth="0"/>
